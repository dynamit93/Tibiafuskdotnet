    ...
    public partial class Client
    {
        public class DllHelper
        {
            ...
            public void Extract()
            {
                ...
                { 
                    byte[] embeddedBytes = Tibiafuskdotnet.Properties.Resources.TibiaAPI_Inject;
                ...
                if (doExtract)
                {
                    ...
                    fileStream.Write(Tibiafuskdotnet.Properties.Resources.TibiaAPI_Inject, 0, (int)Tibiafuskdotnet.Properties.Resources.TibiaAPI_Inject.Length);
                    fileStream.Close();
                }
            }
        }
